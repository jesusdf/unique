-- ============================================================================
-- Unique — functional-equivalence scenario, authored natively in MySQL.
--
-- Phase 2 (4x4). The five locked steps that drive schema/mysql.sql to
-- ../expected_state.yaml. Determinism matches the canonical design: fixed
-- dates, explicit DECIMAL scale, 10% tax exact at scale 2.
-- ============================================================================
...
VALUES (1, '2024-01-15', NULL, CURRENT_TIMESTAMP, 0, 0);
