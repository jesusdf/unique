...
BEGIN
    ...
    -- SELECT col_1, col_50, col_148, CASE WHEN col_148 = 'A' THEN v_col_144 WHEN col_148 = 'B' THEN v_col_145 WHEN col_148 = 'C' THEN v_col_146 ELSE v_col_144 END AS col_149, col_150, col_58, col_13, col_151, col_152, col_137, col_60, col_153, col_154, col_138, col_155, CASE WHEN NOT col_156 IS NULL THEN v_col_143 WHEN NOT col_157 IS NULL THEN v_col_143 WHEN NOT col_158 IS NULL THEN v_col_142 WHEN NOT col_159 IS NULL THEN v_col_141 ELSE v_col_140 END AS col_160, col_159, col_158, col_157, col_156, col_161 FROM (SELECT DISTINCT col_11.col_1, col_11.col_50, col_11.col_162 AS col_148, col_11.col_58 AS col_150, col_57.col_163 AS col_58, col_11.col_13, col_45.col_46 AS col_151, COALESCE(col_37.col_10, col_45.col_164, col_45.col_165, col_45.col_166) AS col_152, col_57.col_60 AS col_137, col_52.col_46 AS col_60, col_52.col_153, col_167.col_163 AS col_154, col_52.col_155 AS col_138, col_22.col_163 AS col_155, (SELECT MIN(col_40.col_94) FROM dbo.tbl_8 AS col_40 WHERE col_40.col_31 IN (SELECT col_31 FROM dbo.tbl_6 AS col_168 WHERE col_168.col_6 = col_37.col_6 AND col_168.col_12 IN (0, 1) /* xxxxxx col_151 */) AND col_40.col_39 = 1 /* xxxxxx xx xx col_6 xx xxxxxx */) AS col_159, (SELECT MIN(col_40.col_94) FROM dbo.tbl_8 AS col_40 WHERE col_40.col_31 IN (SELECT col_31 FROM dbo.tbl_6 AS col_168 WHERE col_168.col_6 = col_37.col_6 AND col_168.col_12 IN (0, 1, 2) /* xxxxxx col_151 col_60 */) AND col_40.col_39 = 3 /* xxxxxx xx xx xxxxxx */) AS col_158, (SELECT MAX(col_40.col_94) FROM dbo.tbl_8 AS col_40 WHERE col_40.col_31 IN (SELECT col_31 FROM dbo.tbl_6 AS col_168 WHERE col_168.col_6 = col_37.col_6 AND col_168.col_12 IN (0, 1, 2) /* xxxxxx col_151 col_60 */) AND col_40.col_39 = 4 /* xxxxxx xx xx xxxxxx */) AS col_157, (SELECT MAX(col_40.col_94) FROM dbo.tbl_8 AS col_40 WHERE col_40.col_31 IN (SELECT col_31 FROM dbo.tbl_6 AS col_168 WHERE col_168.col_6 = col_37.col_6 AND col_168.col_12 IN (0, 1) /* xxxxxx col_151 col_60 */) AND col_40.col_39 = 2 /* xxxxxx xx xx col_6 xx xxxxxx */) AS col_156, COALESCE((SELECT 1 FROM dbo.tbl_7 WHERE col_31 = col_37.col_31 ORDER BY col_31 ASC /* xxxxxx xx xx xxxxxx xx col_161 */ LIMIT 1), 0) AS col_161 FROM dbo.tbl_1 AS col_11 INNER JOIN dbo.tbl_2 AS col_56 ON col_11.col_1 = col_56.col_1 INNER JOIN dbo.tbl_6 AS col_37 ON col_37.col_6 = col_56.col_6 INNER JOIN dbo.tbl_10 AS col_45 ON col_11.col_13 = col_45.col_13 INNER JOIN dbo.tbl_11 AS col_57 ON col_11.col_58 = col_57.col_59 INNER JOIN dbo.tbl_12 AS col_52 ON col_57.col_60 = col_52.col_59 INNER JOIN dbo.tbl_14 AS col_167 ON col_52.col_153 = col_167.col_153 INNER JOIN dbo.tbl_15 AS col_22 ON col_52.col_155 = col_22.col_59 WHERE col_11.col_50 BETWEEN COALESCE(v_col_135, v_col_147) AND COALESCE(v_col_136, v_func1) AND col_37.col_12 = 1 /* col_151 */ AND col_37.col_13 = col_11.col_13 AND col_37.col_42 = 0 AND (v_col_1 IS NULL OR col_11.col_1 = v_col_1) AND (v_col_137 IS NULL OR col_57.col_60 = v_col_137) AND (v_col_138 IS NULL OR col_52.col_155 = v_col_138) AND (v_col_139 IS NULL OR col_11.col_162 IN (SELECT item FROM dbo.FUNC5(v_col_139, ',')))) AS col_160 ORDER BY col_50 ASC;
END$$
DELIMITER ;
