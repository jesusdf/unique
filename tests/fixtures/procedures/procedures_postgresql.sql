...
BEGIN
    ...
    IF ( v_col_1 IS NOT NULL ) THEN
            ...
            IF v_col_6 IS NULL THEN
                        INSERT INTO tbl_3 (col_19, col_20, col_15, col_18) SELECT v_col_15, v_func1, v_col_15, v_func1 WHERE NOT EXISTS(SELECT NULL FROM tbl_2 WHERE col_1 = v_col_1) RETURNING col_6;
