-- ============================================================
-- PostgreSQL fixture: generated from procedures_sqlserver.sql
-- by the unique transpiler (T-SQL -> PostgreSQL).
...
CREATE TABLE IF NOT EXISTS tbl_3 (
  col_6 UUID NOT NULL DEFAULT gen_random_uuid(),
  col_7 INT,
  col_91 VARCHAR(4000),
  col_19 VARCHAR(10),
  col_20 TIMESTAMP,
...
BEGIN
    ...
    UNION ALL
    SELECT v_col_1 AS col_1, 0 AS col_4, NULL AS col_6, NULL AS col_7, NULL AS col_9, NULL AS col_10) col_14
...
BEGIN
    ...
    LIMIT 1), 0) AS col_54, COALESCE((SELECT 1
    FROM tbl_7
    WHERE col_31 = v_col_31 AND EXISTS (SELECT NULL
    FROM tbl_9
    WHERE col_30 = 1 AND NOT (col_43 IS NULL))
...
(
    ...
    v_col_69 TIMESTAMP DEFAULT NULL,
    v_col_70 TIMESTAMP DEFAULT NULL,
    v_col_62 VARCHAR(50) DEFAULT NULL,
    v_col_6 VARCHAR(1000) DEFAULT NULL,
...
DECLARE
    ...
    v_mod VARCHAR(10);
    v_col_74 TEXT;
    v_col_81 VARCHAR(1000);
    v_col_82 TIMESTAMP;
    v_col_83 VARCHAR(500);
    v_col_84 VARCHAR(500);
    v_col_75 VARCHAR(50);
    v_col_85 BIGINT;
    v_col_86 BIGINT;
    v_col_87 BIGINT;
...
(
    ...
    v_col_100 INTEGER DEFAULT NULL,
    v_col_101 INTEGER DEFAULT NULL,
    v_col_102 INTEGER DEFAULT NULL,
    v_col_103 VARCHAR(10) DEFAULT NULL,
    v_col_104 TIMESTAMP DEFAULT NULL,
    v_col_105 INTEGER DEFAULT NULL,
    v_col_106 TEXT DEFAULT NULL
)
LANGUAGE plpgsql
AS $$
DECLARE
...
(
    ...
    v_col_39 INTEGER DEFAULT NULL,
    v_col_94 TIMESTAMP DEFAULT NULL,
    v_col_112 INTEGER DEFAULT NULL,
    v_col_103 VARCHAR(10) DEFAULT NULL,
    v_col_104 TIMESTAMP DEFAULT NULL,
    v_col_101 INTEGER DEFAULT NULL,
    v_col_113 INTEGER DEFAULT NULL,
    v_col_114 TIMESTAMP DEFAULT NULL
)
LANGUAGE plpgsql
AS $$
DECLARE
...
(
    ...
    v_col_18 TIMESTAMP DEFAULT NULL,
    v_col_101 INTEGER DEFAULT NULL,
    v_col_115 UUID DEFAULT NULL,
    v_col_116 INTEGER DEFAULT NULL,
    v_col_117 TIMESTAMP DEFAULT NULL,
    v_col_118 INTEGER DEFAULT NULL,
    v_col_119 INTEGER DEFAULT NULL,
    v_col_120 VARCHAR(10) DEFAULT NULL,
    v_col_121 INTEGER DEFAULT NULL,
    v_col_122 VARCHAR(200) DEFAULT NULL,
    v_col_123 VARCHAR(200) DEFAULT NULL,
    v_col_124 TEXT DEFAULT NULL,
    v_col_125 TEXT DEFAULT NULL,
    v_col_126 TEXT DEFAULT NULL,
    v_col_127 TEXT DEFAULT NULL,
    v_col_128 VARCHAR(200) DEFAULT NULL,
    v_col_129 VARCHAR(200) DEFAULT NULL,
    v_col_130 VARCHAR(1000) DEFAULT NULL,
    v_col_131 VARCHAR(10) DEFAULT NULL,
    v_col_132 TIMESTAMP DEFAULT NULL,
    v_col_103 VARCHAR(10) DEFAULT NULL,
    v_col_104 TIMESTAMP DEFAULT NULL
)
LANGUAGE plpgsql
...
(
    ...
    v_col_18 TIMESTAMP DEFAULT NULL,
    v_col_115 UUID DEFAULT NULL,
    v_col_133 INTEGER DEFAULT NULL,
    v_col_134 VARCHAR(4000) DEFAULT NULL,
    v_col_131 VARCHAR(10) DEFAULT NULL,
    v_col_132 TIMESTAMP DEFAULT NULL,
    v_col_103 VARCHAR(10) DEFAULT NULL,
    v_col_104 TIMESTAMP DEFAULT NULL
    ...
    FROM (
      SELECT DISTINCT
        ...
        (
          SELECT
            MIN(col_40.col_94)
          FROM tbl_8 AS col_40
          WHERE
            col_40.col_31 IN (
              SELECT
                col_31
              FROM tbl_6 AS col_168
              WHERE
      ...
      FROM tbl_1 AS col_11
      INNER JOIN tbl_2 AS col_56
        ON col_11.col_1 = col_56.col_1
      INNER JOIN tbl_6 AS col_37
        ON col_37.col_6 = col_56.col_6
      INNER JOIN tbl_10 AS col_45
        ON col_11.col_13 = col_45.col_13
      INNER JOIN tbl_11 AS col_57
        ON col_11.col_58 = col_57.col_59
      INNER JOIN tbl_12 AS col_52
        ON col_57.col_60 = col_52.col_59
      INNER JOIN tbl_14 AS col_167
        ON col_52.col_153 = col_167.col_153
      INNER JOIN tbl_15 AS col_22
