...
*Empty.* The 2026-07-08 audit backlog and every campaign since (architecture
milestones M0–M4, direction-residue, zero-reduction, corpus waves, challenge
corpus) are closed — see [`docs/MILESTONES.md`](MILESTONES.md). The challenge
corpus (`tests/fixtures/challenge/`, red/blue workflow in
[`skills/SKILL-challenge-corpus.md`](../skills/SKILL-challenge-corpus.md))
remains the live intake for new findings: a new RED batch reopens this section.
