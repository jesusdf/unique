...
class TypeMapper(TransformPass):
    ...
    TYPE_MAP: dict[tuple[str, str], str] = {
        ...
        # Oracle: SERIAL is an auto-increment integer — map it to Oracle's
        # native identity like T-SQL/MySQL do (dropping the identity to a plain
        # NUMBER makes later INSERTs that omit the column fail ORA-01400).
        # BIGSERIAL/SMALLSERIAL already reach this via the emit_ddl serial path.
        ("SERIAL", "oracle"): "NUMBER GENERATED BY DEFAULT AS IDENTITY",
